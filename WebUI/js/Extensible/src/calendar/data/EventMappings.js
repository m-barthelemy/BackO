...
Extensible.calendar.data.EventMappings = {
	    ...
	    CalendarId:  {name: 'CalID', mapping: 'Category', type: 'int'},
	    Title:       {name: 'EvtTitle', mapping: 'Subject'},
	    StartDate:   {name: 'StartDt', mapping: 'Start', type: 'date', dateFormat: 'c'},
	    EndDate:     {name: 'EndDt', mapping: 'End', type: 'date', dateFormat: 'c'},
	    ...
	    CreatedBy:   {name: 'CreatedBy', mapping: 'Owner'},
...
Extensible.calendar.data.EventMappings = {
	    EventId:     {name: 'Id', mapping:'Id', type:'int'},
	    CalendarId:  {name: 'Category', mapping: 'Category', type: 'int'},
	    Title:       {name: 'Subject', mapping: 'Subject'},//EvtTitle
	    StartDate:   {name: 'Start', mapping: 'Start', type: 'date' , dateFormat: 'c'},
	    EndDate:     {name: 'End', mapping: 'End', type: 'date' , dateFormat: 'c'},
	    RRule:       {name: 'Recurrence', mapping: 'Recurrence'},
	    Location:    {name: 'Location', mapping: 'Location'},
	    Notes:       {name: 'Description', mapping: 'Description'},
	    Url:         {name: 'LinkUrl', mapping: 'link_url'},
	    IsAllDay:    {name: 'AllDay', mapping: 'AllDay', type: 'boolean'},
	    Reminder:    {name: 'Reminder', mapping: 'Reminder'},
	    
	    // We can also add some new fields that do not exist in the standard EventRecord:
	    CreatedBy:   {name: 'Owner', mapping: 'Owner'},
	    IsPrivate:   {name: 'Private', mapping:'Private', type:'boolean'}
	};
