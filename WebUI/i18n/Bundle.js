...
Ext.define('Ext.i18n.Bundle', {
	...
	getMsg: function(key, param0){
        return this.getById(key)? Ext.util.Format.htmlDecode(this.getById(key).get('value').replace("{0}", param0)) : key + '.undefined';
    },
    
    getMsg: function(key, param0, param1){
      if(this.getById(key)){
		var val = this.getById(key).get('value').replace("{0}", param0);
        ...
        //return this.getById(key)? Ext.util.Format.htmlDecode(this.getById(key).get('value').replace("{0}", param0).replace("{1}", param1) ) : key + '.undefined';
    },
