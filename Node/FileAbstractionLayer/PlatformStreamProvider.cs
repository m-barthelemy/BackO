...
namespace Node{
	...
	public class PlatformStreamProvider	{

		public static readonly PlatformStreamProvider _instance = new PlatformStreamProvider();

		private PlatformStreamProvider (){
			
		}
		
		public static PlatformStreamProvider Instance(){
			return _instance;	
		}
