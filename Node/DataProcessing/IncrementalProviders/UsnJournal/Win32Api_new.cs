...
namespace Node.Utilities.Native{
	...
	public class Win32Api_new{
        ...
        public static extern bool DeviceIoControl(
            IntPtr hDevice,
            UInt32 dwIoControlCode,
            _FILE_ALLOCATED_RANGE_BUFFER lpInBuffer, 
            Int32 nInBufferSize,
           	IntPtr lpOutBuffer, 
            Int32 nOutBufferSize,
            out int lpBytesReturned, 
       ...
       /* [StructLayout(LayoutKind.Sequential, Pack = 1)]
        ...
        public class UsnEntry : IComparable<UsnEntry>{
			...
			/*public UsnEntry(byte[] recordData){
				...
				_name=System.Text.Encoding.Unicode.GetString(recordData, fileNameOffset, fileNameLength);
        ...
        internal static extern bool GetVolumeNameForVolumeMountPoint(
            string volumeName,
            System.Text.StringBuilder uniqueVolumeName,
